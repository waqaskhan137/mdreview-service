...
a create (e.g. an unknown template id) while core stays free of any template knowledge and the
flag-off import graph is unchanged.
"""


class ReviewCreateRejected(Exception):
    """A create was rejected for a reason the caller should see as a 4xx. Carries the HTTP status and
