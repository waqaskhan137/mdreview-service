...
Tools map 1:1 to the API (16): `create_review` (with optional `project`/`session`/`source_path`
...
`delete_review`, `server_info`, and the comment tools `list_comments` (`document_id`, `status?`=open),
